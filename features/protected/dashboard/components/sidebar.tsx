...
const navByRole: Record<StaffRole, NavItem[]> = {
  ...
  manager: [
    ...
    { label: "Guests", section: "guests", icon: UsersThreeIcon },
    { label: "Vehicle log", section: "vehicle-log", icon: CarIcon },
    { label: "Staff", section: "staff", icon: IdentificationBadgeIcon },
    { label: "Maintenance", section: "maintenance", icon: WrenchIcon },
    { label: "Refunds & promos", section: "refunds", icon: TagIcon },
    { label: "Analytics", section: "analytics", icon: ChartBarIcon },
